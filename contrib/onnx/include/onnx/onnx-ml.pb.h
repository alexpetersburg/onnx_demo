...
constexpr TensorProto_DataType TensorProto_DataType_DataType_MAX = static_cast<TensorProto_DataType>(20);
constexpr int TensorProto_DataType_DataType_ARRAYSIZE = 20 + 1;
ONNX_API const ::google::protobuf::EnumDescriptor*
...
constexpr Version Version_MAX = static_cast<Version>(9);
constexpr int Version_ARRAYSIZE = 9 + 1;
ONNX_API const ::google::protobuf::EnumDescriptor*
Version_descriptor();
template <typename T>
